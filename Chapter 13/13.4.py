...
print("### Captcha solution attempt 1: " + captchaResponse)

captchaResponse = captchaResponse[:-1]
print("### Captcha solution attempt 2: " + captchaResponse)
...
if len(captchaResponse) == 5:
    ...
    print("### There was a problem reading the CAPTCHA correctly! len(captchaResponse) = ", + len(captchaResponse))